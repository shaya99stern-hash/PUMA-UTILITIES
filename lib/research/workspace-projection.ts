    ...
    for (const claim of trustedClaims(graph, propertyEntityId, 'utility.provider')) {
      ...
      projectedUtilities.push({
        ...
        benchmarkCost: benchmark?.utilityId === utilityEntity.id ? {
          ...
          annualFixedWaterCharge: benchmark.annualFixedWaterCharge,
          monthlyFixedWaterCharge: benchmark.monthlyFixedWaterCharge,
          annualEstimatedWaterCost: benchmark.annualEstimatedWaterCost,
          monthlyEstimatedWaterCost: benchmark.monthlyEstimatedWaterCost,
          ...
          includesFixedCharges: benchmark.includesFixedCharges,
